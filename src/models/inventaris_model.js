...
const inventarisModel = {
  ...
  insertInventarisC: (data) => {
    ...
    let query = `
      INSERT INTO aset.kib_inventaris (
        ...
        ${data.c_bertingkat ? `${data.c_bertingkat}` : null},
        ${data.c_beton ? `${data.c_beton}` : null},
  ...
  insertInventarisD: (kib_id, data) => { console.log(data); },
  ...
  updateInventarisC: (kib_id, data) => {
    ...
    let query = `
      ...
      SET
        ...
        c_bertingkat                         = ${data.c_bertingkat ? `${data.c_bertingkat}` : null},
        c_beton                              = ${data.c_beton ? `${data.c_beton}` : null},
  ...
  updateInventarisD: (kib_id, data) => { console.log(data); },
};
